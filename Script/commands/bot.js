...
     return api.sendMessage("কিরে লুচ্চা সেন্টি না খেয়ে আমার বস হাসান এর ইনবক্স এ যা🙂 ", threadID);
   };
  
   if ((event.body.toLowerCase() == "@Hefjul Bari Shahadat") || (event.body.toLowerCase() == "oi kire") ||(event.body.toLowerCase() == "@Hefjul Bari Shahadat") || (event.body.toLowerCase() == "...")) {
...
   if ((event.body.toLowerCase() == "🫦") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("কিরে হালা লুচ্চা, চুদার শখ শখ উঠছে নাকি এইগুলা দিস কেন 😒 ।", threadID);
   }; 
...
  if ((event.body.toLowerCase() == "hasan") || (event.body.toLowerCase() == "Ullash bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "হাসান")) {
...
     return api.sendMessage("He is হাসান ッ❤️ তাকে সবাই আজরাইল নামে  চিনে🤙", threadID);
   }; 
...
   if ((event.body.toLowerCase() == "@ব্ঁদ্ঁনা্ঁ চো্ঁরে্ঁর্ঁ ব্ঁউ্ঁ") || (event.body.toLowerCase() == "tahiya ")) {
...
  if ((event.body.toLowerCase() == "প্রিয়া") || (event.body.toLowerCase() == "Ziniya")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস হাসান এর বউ এর নাম..!😠🥰⛏️", threadID);
   }; 
...
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে আমার বস হাসান কে পারলে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   }; 

   if ((event.body.toLowerCase() == "....") || (event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "😠") || (event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "😾")) {
     return api.sendMessage("️রাগ করে না সোনা পাখি আমার বস হাসান এর কাছে চলে যাও ঠান্ডা করে দিবে 🥰", threadID);
   }; 
...
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার বস হাসানকেও একটা গফ দে<🥺", threadID);
   };
   
...
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে  আমার বস হাসান এর ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   }; 
